...
function Gameboard({setGameStarted, setPlayerButtonPick}: IgameBoard) {
  ...
  return (
    <div>
      ...
      <section className='mx-auto w-11/12 flex flex-wrap z-10 mt-24 lg:mt-16'>

        {/* Set onClick handler only to elements not wrapper div !! */}
        <div onClick={setGame} className='w-full mb-4 z-10' id='scissors1'>
          <div className='bg-scissors-bg-first -mb-[116px] rounded-full w-28 h-28 mx-auto lg:w-40 lg:h-40 lg:-mb-[10.5rem]' id='scissors2'></div>
          <div className='bg-scissors-bg-last -mb-24 rounded-full w-28 h-28 mx-auto lg:w-40 lg:h-40 lg:-mb-36' id='scissors3'></div>
          <div className='bg-slate-300 -mb-[76px] rounded-full w-20 h-20 z-10 mx-auto lg:w-32 lg:h-32 lg:-mb-[7.6rem]'id='scissors4'></div>
          <div className='bg-white rounded-full -mb-16 w-20 h-20 z-20 mx-auto lg:w-32 lg:h-32 lg:-mb-[6.5rem]' id='scissors5'></div>
          <img src={Scissors} alt='Scissors button' className='mx-auto w-9 z-30 lg:w-16' id='scissors6'/>
        </div>

        {/* border-2 border-red-400 */}
        <div onClick={setGame} className='w-1/2 pr-14 pb-12 z-10 sm:pr-0 sm:pl-12 md:pl-32 md:pt-2 lg:pl-56' id='spock1'>
        ...
        <div onClick={setGame} className='w-1/2 pl-14 z-10 sm:pl-0 sm:pr-12 md:pr-32 md:pt-2 lg:pr-56' id='paper1'>
        ...
        <div onClick={setGame} className='w-1/2 z-10 sm:pl-32 sm:pt-4 md:pl-48 lg:pl-80' id='lizard1'>
        ...
        <div onClick={setGame} className='w-1/2 z-10 sm:pr-32 sm:pt-4 md:pr-48 lg:pr-80' id='rock1'>
      ...
      <img src={Pentagon} alt='Pentagon game board background' className='fixed top-2/4 left-2/4 -translate-x-2/4 -translate-y-2/4 w-60 lg:w-80 lg:top-[60%] '/> 
